...
class BurialButton extends StatelessWidget {
  ...
  Widget _buildButton() {
    ...
    final shadows = state == BurialButtonState.processing
        ? [
            BoxShadow(
              color: const Color(0xFFF37255).withOpacity(0.6),
              blurRadius: 30,
              spreadRadius: 5,
            ),
            BoxShadow(
              color: const Color(0xFFFF3C00).withOpacity(0.4),
              blurRadius: 15,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: const Color(0xFFFF3C00).withOpacity(0.5),
          width: 2,
        ),
        boxShadow: shadows,
      ),
