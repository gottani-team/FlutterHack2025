...
mixin _$UserSession {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, isAnonymous, createdAt);

  @override
  String toString() {
    return 'UserSession(id: $id, isAnonymous: $isAnonymous, createdAt: $createdAt)';
  }
}
...
abstract mixin class $UserSessionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, bool isAnonymous, DateTime createdAt});
}
...
extension UserSessionPatterns on UserSession {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, bool isAnonymous, DateTime createdAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UserSession() when $default != null:
        return $default(_that.id, _that.isAnonymous, _that.createdAt);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String id, bool isAnonymous, DateTime createdAt) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _UserSession():
...
class _UserSession implements UserSession {
  const _UserSession(
      {required this.id, required this.isAnonymous, required this.createdAt});
